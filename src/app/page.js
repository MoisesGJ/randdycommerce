                ...
                <div>
                  ...
                  >
                    ...
                    >
                      ...
                      <h2 className="text-4xl text-center w-full truncate text-dgreen">
                        {name}
                      </h2>
                      {shoppingCart.some((product) => product.id === id) && (
                        <>
                          <span className="text-transparent bg-clip-text bg-dorange text-2xl text-center absolute end-1/2 top-1/2 transition translate-x-1/2 -translate-y-1/2">
                            ¡Agregado al carrito!
                          </span>
                        </>
                      )}
      ...
      <div
        className={`${
          view
            ...
            : "translate-x-full"
        } fixed top-0 right-0 z-40 h-screen w-full md:w-1/2 p-4 overflow-y-auto bg-orange-400/50 text-white text-2xl flex flex-col justify-between overflow-hidden md:rounded-s-xl`}
        tabIndex="-1"
        aria-labelledby="drawer-right-label"
      >
        <Luz></Luz>
        <div className="absolute z-50">
          <h5 className="inline-flex text-center justify-center items-center mb-4 text-4xl font-lucky">
            Tu carrito
          </h5>
          <button
            type="button"
          ...
          <div className="flex justify-between items-center ">
            <div className="h-32 flex justify-start gap-3">
              ...
              <button className="font-lucky  text-xl bg-dgreen p-3  rounded-full absolute right-9 hover:animate-wiggle-more hover:animate-infinite">
                Ir a pagar
              </button>
            </div>
          </div>
